...
public class SPipesDebugClassPathScanner extends BootAwareClasspathScanner {
    private static final Logger LOG = LoggerFactory.getLogger(SPipesDebugClassPathScanner.class);
